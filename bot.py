...
BOT_TOKEN = (os.getenv("8784120583:AAELHpeCZrctW8kHnBHTDWlJPejVdF5qMwY") or "").strip()
...
print(f"🔍 ENV keys: {[k for k in os.environ.keys() if 'TOKEN' in k or 'ADMIN' in k or 'BOT' in k]}")

if not BOT_TOKEN:
    print("❌ BOT_TOKEN خالیه! لطفا توی Render > Environment چک کن")
    print(f"Available: {list(os.environ.keys())[:20]}")
    raise ValueError("BOT_TOKEN تنظیم نشده! - توی Render > Environment > BOT_TOKEN رو اضافه کن و Save بزن")
